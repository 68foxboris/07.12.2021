...
inline ePyObject Impl_PyUnicode_FromString(const char* file, int line, const char *fmt, ...)
{
	va_list ap;
	va_start(ap, fmt);
...
#define PyUnicode_FromString(str) Impl_PyString_FromString(__FILE__, __LINE__, str)
...
#define PyUnicode_FromString(str) Impl_PyString_FromString(str)
